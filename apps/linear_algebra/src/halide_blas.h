...
#include "halide_sgemm_trans_A.h"
#include "halide_dgemm_trans_A.h"
#include "halide_sgemm_trans_B.h"
#include "halide_dgemm_trans_B.h"
#include "halide_sgemm_trans_AB.h"
#include "halide_dgemm_trans_AB.h"
...
inline int halide_sgemm(bool transA, bool transB, float a, buffer_t *A, buffer_t *B, float b, buffer_t *C) {
    if (!transA && !transB) {
        ...
        return halide_sgemm_trans_A(a, A, B, b, C, C);
    } else if (transB) {
        // TODO: transposed multiplication not implemented yet.
        return halide_sgemm_trans_B(a, A, B, b, C, C);
    } else {
        // TODO: transposed multiplication not implemented yet.
        return halide_sgemm_trans_AB(a, A, B, b, C, C);
    }
    return -1;
}
...
inline int halide_dgemm(bool transA, bool transB, double a, buffer_t *A, buffer_t *B, double b, buffer_t *C) {
    if (!transA && !transB) {
        ...
        // TODO: transposed multiplication not implemented yet.
        return halide_dgemm_trans_A(a, A, B, b, C, C);
    } else if (transB) {
        // TODO: transposed multiplication not implemented yet.
        return halide_dgemm_trans_B(a, A, B, b, C, C);
    } else {
        // TODO: transposed multiplication not implemented yet.
        return halide_dgemm_trans_AB(a, A, B, b, C, C);
    }
    return -1;
}
